...
def validate_candidate(candidate: SemanticCandidate, raw_query: str,
    ...
    location_explicit = any(isinstance(item, LocationConstraint) for item in deduped)
    location_ambiguous = any(
    ...
    return SemanticParseResult(
        ...
        location_wording_requested=location_ambiguous and not location_explicit,
        summary=summary)
